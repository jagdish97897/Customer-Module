...
const Party = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFormData({
                ...
                gst: { registrationType: '', servicesType: '', defaultGST: '', GSTIN: '', Remarks: '' },
                tds: { PAN: '', TANNo: '', declarationFor: '', tdsStatus: '', tdsCode: '', natureOfPayment: '', tdsSection: '', exemptionCertNo: '', exemptionLimit: '', validUpto: '', PANImage: '', imageOfDeclaration: '', remarks: '' },
                itr: { ITRNo: '', ITRSubmissionDate: '', ITRAttachment: '', Remarks: '' },
                generalDetails: { marketingPerson: '', bankUploadPrefix: '', partyStatus: '', reason: '', paymentMethod: '', paymentTerms: '', creditLimit: '', allocated: '', deliveryPaymentMode: '', deliveryAt: '', outstandingAmt: '', graceDays: '', lockDate: '', paymentBase: '', billFor: '', billAttachReport: '', urlForTracking: '', consignmentAttachReport: '', introDate: '', closeDate: '', remarks: '' },
                bankDetails: { bankName: '', ifscCode: '', mobile: '', email: '', branchName: '', bankAccountNo: '', beneficiaryName: '', cancelledChequeOrPassbook: '', remarks: '' },
            });
        } catch (error) {
    ...
    const handleCountryChange = (e) => {
        ...
        setFormData((prevData) => ({
            ...prevData,
            contact: { ...prevData.contact, Country: selectedCountry, State: '', City: '' },
        }));
    };
    ...
    const handleStateChange = (e) => {
        ...
        setFormData((prevData) => ({
            ...prevData,
            contact: { ...prevData.contact, State: selectedState, City: '' },
        }));
    };
    ...
    const handleCityChange = (e) => {
        ...
        setFormData((prevData) => ({
            ...prevData,
            contact: { ...prevData.contact, City: selectedCity },
        }));
    };
